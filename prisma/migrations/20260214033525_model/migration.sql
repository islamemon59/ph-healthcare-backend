...
-- CreateIndex
CREATE INDEX "appointments_scheduledId_idx" ON "appointments"("scheduledId");
...
-- CreateIndex
CREATE UNIQUE INDEX "prescriptions_doctorId_key" ON "prescriptions"("doctorId");
...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_scheduledId_fkey" FOREIGN KEY ("scheduledId") REFERENCES "schedules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
